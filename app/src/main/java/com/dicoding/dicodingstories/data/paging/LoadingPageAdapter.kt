...
import com.dicoding.dicodingstories.databinding.LayoutLoadingBinding

class LoadingPageAdapter(private val retry: () -> Unit) : LoadStateAdapter<LoadingPageAdapter.LoadingStateViewHolder>() {
